...
const DatePickerInput = ({ label1 = 'startTime', label2 = 'endTime', defaultValue = [60, 66] }) => {
    ...
    <div className="w-full">
      ...
      <div className="flex justify-around">
        <div className="flex justify-between gap-x-4 max-w-fit">
          <p className="text-[#9A9A9A] text-lg font-normal block pb-2 self-center mr-3">Start time</p>
        ...
        <div className="flex justify-between gap-x-4 max-w-fit">
          <p className="text-[#9A9A9A] text-lg font-normal block pb-2 self-center mr-3">End time</p>
          <div className={`relative border-[#DADADA] border rounded-[5px]`}>
            <input
      ...
      {(meta1.touched && meta1.error && <ErrorMessage message={meta1.error} />) || null}
      {(meta2.touched && meta2.error && <ErrorMessage message={meta2.error} />) || null}
    </div>
  );
};
