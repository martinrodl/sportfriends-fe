...
import { useCreateEventMutation } from '@sportfriends-fe/shared/data/services';
import {
  TextInput,
  DatePickerInput,
  MapInput,
...
const CreateEventForm = () => {
  const [createEvent, { isSuccess, error, isLoading }] =
  ...
  return (
    <div className="w-full min-h-screen md:px-10 px-5 md:py-20 py-14 max-w-7xl mx-auto">
      ...
      <p className="text-xl text-center font-normal text-[#9A9A9A] mb-10 max-w-[525px] mx-auto">
        Fill neccessary details of the event and get sport buddies to joined
        you.
      </p>
      <Formik
        initialValues={{
        ...
        <Form>
          <div className="max-w-[675px] mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 mb-8">
              <div>
                <p className="text-[#9A9A9A] text-lg font-normal block pb-2">
                  Min Participants
                </p>
