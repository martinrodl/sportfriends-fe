...
import { ErrorMessage } from '@sportfriends-fe/shared/ui';
import { useDeleteUserDatingPostMutation } from '@sportfriends-fe/shared/services';

const PartnerCard = ({ id, title, description, sport }) => {
  const [deleteUserDatingPost, { error, isError, isLoading }] =
